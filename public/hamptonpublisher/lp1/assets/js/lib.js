...
! function(t) {
	...
	t.fn.carouselTicker = function(s) {
		function n() {
			a.itemsWidth = 0, a.$items.each(function() {
				var e = t(this),
		...
		function o() {
			a.itemsHeight = 0, a.$items.each(function() {
				var e = t(this);
		...
		function r() {
			u.on("mouseover", function() {
				("horizontal" === a.settings.mode ? a.itemsWidth > a.$parent.width() : a.itemsHeight > a.$parent.height()) && (clearInterval(a.intervalPointer), a.intervalPointer = !1)
			})
		}
		...
		function c() {
			u.on("mouseleave", function() {
				...
				if(a.isMousemove && (a.$list.off(a.eventTypes.mousemove), a.$list.trigger(a.eventTypes.mouseup)), t) {
					if(a.intervalPointer) return;
		...
		function l() {
			...
			a.$list.on(a.eventTypes.mousedown, function(i) {
				...
				t(i.target).off("click"), clearInterval(a.intervalPointer), a.intervalPointer = !1, e = !0, o.on(a.eventTypes.mousemove, function(i) {
					...
					a.touch && t(document).on("touchmove", function(t) {
						t.preventDefault()
					}), "horizontal" === a.settings.mode ? a.directionSwitcher = u >= 0 ? -1 : 1 : "vertical" === a.settings.mode && (a.directionSwitcher = d >= 0 ? -1 : 1), a.isMousemove = !0, e && ("horizontal" === a.settings.mode ? (r - u >= 0 && 1 === a.directionSwitcher && (o.css("left", "-=" + a.itemsWidth), r = -a.itemsWidth, s = i.clientX || event.touches[0].pageX, u = 0), r - u <= -a.itemsWidth && -1 === a.directionSwitcher && (o.css("left", 0), r = 0, u = 0, s = i.clientX || event.touches[0].pageX), o.css("left", r - u + "px")) : "vertical" === a.settings.mode && (c - d >= 0 && 1 === a.directionSwitcher && (o.css("top", "-=" + a.itemsHeight), c = -a.itemsHeight, n = i.clientY || event.touches[0].pageY, d = 0), c - d <= -a.itemsHeight && -1 === a.directionSwitcher && (o.css("top", 0), c = 0, d = 0, n = i.clientY || event.touches[0].pageY), o.css("top", c - d + "px")))
				})
			})
		}
		if(0 == this.length) return this;
		...
		var a = {},
			h = this,
			u = t(this);
		e.el = this, e.$el = t(this);
		var d = function() {
				a.settings = t.extend({}, i, s), a.intervalPointer = null, a.directionSwitcher = "prev" === a.settings.direction ? -1 : 1, a.itemsWidth = 0, a.childsWidth = 0, a.itemsHeight = 0, a.childsHeight = 0, a.$list = u.children("ul"), a.$items = a.$list.children("li"), a.isInitialize = !1, a.isMousemove = !1, a.$parent = u.parent(), a.wrapCls = "carouselTicker__wrap", a.loaderCls = "carouselTicker__loader", a.cloneCls = "carouselTicker__clone", a.touch = "ontouchstart" in document.documentElement, a.eventTypes = {
			...
			p = function() {
				function e() {
					u.children().hasClass(a.wrapCls) || (t("<div class='" + a.loaderCls + "'></div>").appendTo(u), u.find("." + a.wrapCls).css({
						position: "relative"
					}), a.$list.wrap("<div class='carouselTicker__wrap' style='position: relative; overflow: hidden; user-select: none; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; -o-user-select: none;'></div>"), a.$items.clone().addClass(a.cloneCls).appendTo(a.$list), a.$list.css({
						position: "relative"
					}), a.isInitialize = !0, a.settings.onCarouselTickerLoad(), m())
				}
				"horizontal" === a.settings.mode ? (n(), a.itemsWidth > a.$parent.width() && (u.find("." + a.wrapCls).css({
					width: a.$parent.width() + "px"
				}), a.$list.css({
					width: 2 * a.itemsWidth,
					left: 0
				}), e())) : "vertical" === a.settings.mode && (o(), a.itemsHeight > a.$parent.height() && (u.find("." + a.wrapCls).css({
					height: a.$parent.height() + "px"
				}), a.$list.css({
					height: 2 * a.itemsHeight,
					top: 0
				}), e())), a.isInitialize && u.on("dragstart", function(t) {
					return "IMG" != t.target.nodeName.toUpperCase() && "A" != t.target.nodeName.toUpperCase() && void 0
				})
			},
			m = function() {
				u.find("." + a.loaderCls).length && u.find("." + a.loaderCls).remove(), a.intervalPointer = setInterval(function() {
					v()
				}, a.settings.delay), r(), c(), l()
			},
			v = function() {
				var t = "horizontal" === a.settings.mode ? "left" : "top",
					e = "horizontal" === a.settings.mode ? a.itemsWidth : a.itemsHeight;
				a.$list.css(t, "+=" + a.directionSwitcher * a.settings.speed + "px"), "prev" === a.settings.direction && Math.abs(parseInt(a.$list.css(t))) >= e && a.$list.css(t, 0), "next" === a.settings.direction && parseInt(a.$list.css(t)) >= 0 && a.$list.css(t, -e + "px")
			};
		return h.resizeTicker = function() {
			n(), a.itemsWidth > a.$parent.width() ? a.isInitialize || d() : a.isInitialize && h.destructor()
		}, h.stop = function() {
			clearInterval(a.intervalPointer), a.intervalPointer = !1
		}, h.run = function() {
			m()
		}, h.destructor = function() {
			u.find("." + a.cloneCls).remove(), u.find("." + a.wrapCls).length && (a.$list.unwrap(), a.$list.css({
				left: "auto",
				position: "static",
				width: "auto"
			}), u.css({
				width: "auto",
				position: "static"
			})), clearInterval(a.intervalPointer), a.isInitialize = !1, a.intervalPointer = !1
		}, h.reloadCarouselTicker = function(t) {
			void 0 != t && (s = t), h.destructor(), d()
