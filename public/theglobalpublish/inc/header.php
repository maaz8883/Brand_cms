                    ...
                    <div class="col-xxl-7 col-xl-7 col-lg-8 col-md-12 col-12 headerMenuMain">
                        ...
                        <div class="headerMenuWrap">
                            <div class="mobile-logo">
                                <a href="">
                                    <img src="assets/images/mob-logo.webp" alt="Logo">
                                </a>
                            </div>
                            <ul>
                                ...
                                <li class="hasChild parentMenu">
                                    <span><a href="javascript:;">Ghostwriting <svg
                                        ...
                                        <ul class="dropDown">
                                            <li><a
                                                    href="ghostwriting-services">Ghostwriting</a>
                                            </li>
                                            <li><a href="ebook-writing">Ebook Writers</a>
                                            </li>
                                            <li><a href="memoir-writing">Memoir
                                                    Writing</a></li>
                                            <li><a href="biography-writing">Biography
                                                    Writing</a></li>
                                            <li><a href="business-book-writing">Business
                                                    Book Writing</a></li>
                                            <li><a
                                                    href="non-fiction-writing">Non-Fiction</a>
                                            </li>
                                ...
                                <li class="hasChild parentMenu"><span><a href="javascript:;">Fiction Writing <svg
                                            ...
                                            <!-- <i class="fa-solid fa-chevron-down"></i> Font Awesome fontawesome.com --></a>
                                        <ul class="dropDown">
                                            <li><a href="fiction-writing">Fiction
                                                    Writing</a></li>
                                            <li><a href="action-writing">Action
                                                    Adventure</a></li>
                                            <li><a href="fantasy-writing">Fantasy
                                                    Writing</a></li>
                                            <li><a href="science-fiction-writing">Sci-Fi
                                                    Writing</a></li>
                                            <li><a href="horror-book-writing">Horror
                                                    Writing</a></li>
                                            <li><a href="drama-writing">Drama Writing</a>
                                            </li>
                                            <!-- <li><a href="adventure-writing">Adventure Writing</a></li> -->
                                            <li><a href="suspense-thriller-writing">Suspense/Thriller
                                                    Writing</a>
                                            </li>
                                            <li><a href="romance-writing">Romance
                                                    Writing</a></li>
                                            <li><a href="mystery-writing">Mystery
                                                    Writing</a></li>
                                        </ul>
                                        <div class="openDropdown"><svg class="svg-inline--fa fa-chevron-down"
                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                ...
                                <li class="hasChild parentMenu"><span><a href="javascript:;">Editing &amp;
                                            ...
                                            <!-- <i class="fa-solid fa-chevron-down"></i> Font Awesome fontawesome.com --></a>
                                        <ul class="dropDown">
                                            <li><a href="book-editing-services">Book
                                                    Editing</a></li>
                                            <li><a href="book-formatting-services">Book
                                                    Formatting</a></li>
                                        </ul>
                                        <div class="openDropdown"><svg class="svg-inline--fa fa-chevron-down"
                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                ...
                                <li class="hasChild parentMenu"><span><a href="javascript:;">Other Services <svg
                                            ...
                                            <!-- <i class="fa-solid fa-chevron-down"></i> Font Awesome fontawesome.com --></a>
                                        <ul class="dropDown">
                                            <li><a href="book-marketing">Book
                                                    Marketing</a></li>
                                            <!-- <li><a href="book-publishing">Book Publishing</a></li> -->
                                            <li><a href="audiobook-narrators">Audio
                                                    Books</a></li>
                                            <li><a href="author-website-design">Author
                                                    Web Design</a></li>
                                        </ul>
                                        <div class="openDropdown"><svg class="svg-inline--fa fa-chevron-down"
                                                aria-hidden="true" focusable="false" data-prefix="fas"
