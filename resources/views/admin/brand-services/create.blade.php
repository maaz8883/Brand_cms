...
@section('title', 'New service page')
@section('page-title', 'New service page')
...
<form action="{{ route('admin.brands.services.store', $brand) }}" method="POST" enctype="multipart/form-data" class="brand-service-form">
    @csrf
