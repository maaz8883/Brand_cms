                    ...
                    @forelse($children as $child)
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                ...
                                <form action="{{ route('admin.brands.services.destroy', [$brand, $child]) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this service page and all nested sub-services?');">
                                    @csrf
                                    @method('DELETE')
