                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description_en') is-invalid @enderror" id="description_en" name="description_en" rows="4" placeholder="Category description in English">{{ old('description_en') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description_de') is-invalid @enderror" id="description_de" name="description_de" rows="4" placeholder="Category description in German">{{ old('description_de') }}</textarea>
