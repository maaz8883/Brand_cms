...
<link rel="preconnect" href="https://static.zdassets.com/"> <link rel="dns-prefetch" href="https://static.zdassets.com/">
<!-- Start of LiveChat (www.livechat.com) code -->
 <!-- <script> function loadZendeskWidget(){var t=document.createElement("script");t.type="text/javascript",t.id="ze-snippet",t.async=!0,t.src="https://static.zdassets.com/ekr/snippet.js?key=10b11ce3-0be0-4ff9-af28-daf706752f2a",document.getElementsByTagName("head")[0].appendChild(t)}setTimeout(function(){loadZendeskWidget()},5e3),setTimeout(function(){function t(){$zopim.livechat.window.show()}function e(){$zopim.livechat.window.show()}zE(function(){zE.activate()}),zE(function(){$zopim.livechat.setOnUnreadMsgs(function(t){t>0&&!$zopim.livechat.window.getDisplay()&&$zopim.livechat.window.show()})})},6e3),$(".chat, .chatt").click(function(){$zopim.livechat.window.toggle()});</script>  --> 
<script> function loadZendeskWidget(){var e=document.createElement("script");e.type="text/javascript",e.id="ze-snippet",e.async=!0,e.src="https://static.zdassets.com/ekr/snippet.js?key=10b11ce3-0be0-4ff9-af28-daf706752f2a",document.getElementsByTagName("head")[0].appendChild(e)}setTimeout(function(){loadZendeskWidget()},2e3);
function initZendesk(){if("undefined"==typeof zE||"undefined"==typeof $zopim){setTimeout(initZendesk,500);return}zE(function(){zE.activate()}),zE(function(){$zopim.livechat.setOnUnreadMsgs(function(n){n>0&&!$zopim.livechat.window.getDisplay()&&$zopim.livechat.window.show()})})}setTimeout(initZendesk,3e3),$(".chat, .chatt").click(function(){"undefined"!=typeof $zopim&&$zopim.livechat?$zopim.livechat.window.toggle():console.warn("Zendesk chat not loaded yet")});</script>
